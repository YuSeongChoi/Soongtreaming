...
import com.example.soongtreaming_1.*;
...
//        Intent intent = new Intent(this, TestListFragment.class);
//        startActivity(intent);
    ...
    public void onItemSelected(String id) {
        ...
        try {
            ...
            Class testClass = Class.forName( "com.example.soongtreaming_1." + className );
